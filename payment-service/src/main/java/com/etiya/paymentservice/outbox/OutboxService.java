...
public class OutboxService {
     ...
     *
     * @param aggregateType domain aggregate, e.g. {@code "Payment"}
     * @param aggregateId   aggregate instance id, e.g. the payment id
     * @param eventType     logical event name, e.g. {@code "PaymentCreated"}
