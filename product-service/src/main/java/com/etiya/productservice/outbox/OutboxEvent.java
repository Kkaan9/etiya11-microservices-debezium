...
public class OutboxEvent {
    ...
    /** Domain aggregate the event belongs to, e.g. {@code "Product"}. */
    @Column(nullable = false)
    private String aggregateType;

    /** Identifier of the aggregate instance, e.g. the product id. */
    @Column(nullable = false)
    private String aggregateId;

    /** Logical event name, e.g. {@code "ProductStockUpdated"}. */
    @Column(nullable = false)
