...
public class OutboxService {
     ...
     *
     * @param aggregateType domain aggregate, e.g. {@code "Product"}
     * @param aggregateId   aggregate instance id, e.g. the product id
     * @param eventType     logical event name, e.g. {@code "ProductStockUpdated"}
